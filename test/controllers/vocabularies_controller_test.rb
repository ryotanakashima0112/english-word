...
class VocabulariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create vocabulary" do
    assert_difference('Vocabulary.count') do
      post vocabularies_url, params: { vocabulary: { count: @vocabulary.count, meaning: @vocabulary.meaning, word: @vocabulary.word } }
    end
  ...
  test "should update vocabulary" do
    patch vocabulary_url(@vocabulary), params: { vocabulary: { count: @vocabulary.count, meaning: @vocabulary.meaning, word: @vocabulary.word } }
